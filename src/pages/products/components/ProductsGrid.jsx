...
// ProductCard adalah kartu produk di mana seluruh areanya bisa diklik lewat teknik "full-card link":
// Link nama produk punya `after:absolute after:inset-0` yang menutupi seluruh kartu, —
// tanpa membungkus semua elemen dalam satu <a> yang merusak aksesibilitas.
// Tombol edit/hapus punya `relative z-10` agar berada di atas layer pseudo-element link.
